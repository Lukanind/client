    ...
    <svg 
        ...
        <g id="Page-1" stroke={color} stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Trash">
                ...
                <path d="M6,6 L6.96683,19.5356 C6.98552,19.7973 7.20324,20 7.46556,20 L16.5344,20 C16.7968,20 17.0145,19.7973 17.0332,19.5356 L18,6" id="Path" stroke="#0C0310" stroke-width="2" stroke-linecap="round">
    
    </path>
                <line x1="4" y1="6" x2="20" y2="6" id="Path" stroke={color} stroke-width="2" stroke-linecap="round">
    
    </line>
                <line x1="10" y1="10" x2="10" y2="16" id="Path" stroke={color} stroke-width="2" stroke-linecap="round">
